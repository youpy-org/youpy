...
class Keys:
    ...
    one         = Key(name="1",           code=(pygame.K_1, pygame.K_KP_1))
    two         = Key(name="2",           code=(pygame.K_2, pygame.K_KP_2))
    three       = Key(name="3",           code=(pygame.K_3, pygame.K_KP_3))
    four        = Key(name="4",           code=(pygame.K_4, pygame.K_KP_4))
    five        = Key(name="5",           code=(pygame.K_5, pygame.K_KP_5))
    six         = Key(name="6",           code=(pygame.K_6, pygame.K_KP_6))
    seven       = Key(name="7",           code=(pygame.K_7, pygame.K_KP_7))
    eight       = Key(name="8",           code=(pygame.K_8, pygame.K_KP_8))
    nine        = Key(name="9",           code=(pygame.K_9, pygame.K_KP_9))
    zero        = Key(name="0",           code=(pygame.K_0, pygame.K_KP_0))
